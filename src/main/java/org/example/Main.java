...
public class Main {
    public static String getrandomsurprise() {
        ArrayList<String> surpriseList = new ArrayList<>();
        surpriseList.add("bonus 500₪");
        surpriseList.add(null);
        surpriseList.add("bonus 600₪");
        Random rand = new Random();
        return surpriseList.get(rand.nextInt(surpriseList.size()));
    }
    ...
    public static void main(String[] args) {
        ...
        employeeArrayList.add(new Employee(1,EnumPizzaStoreName.PIZZADOMINOS, getRandomSalary(),getRandomPizzaRank(), getRandomDate(),getrandomsurprise()));
        employeeArrayList.add(new Employee(2,EnumPizzaStoreName.PIZZAHUT, getRandomSalary(),getRandomPizzaRank(), getRandomDate(),getrandomsurprise()));
        employeeArrayList.add(new Employee(3,EnumPizzaStoreName.PIZZADOMINOS, getRandomSalary(),getRandomPizzaRank(), getRandomDate(),getrandomsurprise()));
        employeeArrayList.add(new Employee(4,EnumPizzaStoreName.PIZZAHUT, getRandomSalary(),getRandomPizzaRank(), getRandomDate(),getrandomsurprise()));
        employeeArrayList.add(new Employee(5,EnumPizzaStoreName.PIZZAHUT, getRandomSalary(),getRandomPizzaRank(), getRandomDate(),getrandomsurprise()));
